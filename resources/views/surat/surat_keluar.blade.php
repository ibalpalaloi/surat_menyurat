...
<div class="modal fade" id="modal_tambah_surat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/post_surat_keluar" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label>Date:</label>
                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                    <input name="tgl_keluar" type="text" class="form-control datetimepicker-input" data-target="#reservationdate"/>
    ...
    <div class="card-header">
      ...
      <div class="card-tools">
        <div class="input-group input-group-sm" style="width: 150px;">
          <button type="button" data-toggle="modal" data-target="#modal_tambah_surat">Input Surat Keluar</button>
        </div>
      </div>
    </div>
    <!-- /.card-header -->
        ...
        <tbody>
          ...
          @foreach ($surat_keluar as $data)
              <tr>
                ...
                <td>
                    <a class="btn btn-danger" href="/hapus_surat_keluar/{{$data->id}}" role="button">Hapus</a>
                </td>
              </tr>
          @endforeach
        </tbody>
